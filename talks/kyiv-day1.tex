...
\begin{frame}[label={sec:org8c82e79},fragile]{Game}
 \begin{columns}
...
\begin{frame}[label={sec:orga108229},fragile]{Introducing abstractions}
 \begin{columns}
...
\begin{frame}[label={sec:orgfc9eef0},fragile]{Summoning the summoner}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Introducible[A] {
...
\begin{frame}[label={sec:org52e0731}]{What have we done?}
...
\begin{frame}[label={sec:orgb20bc02},fragile]{Type classes: abstraction}
 Abstraction holds. Proof is the \texttt{introduce} function itself.
...
\begin{frame}[label={sec:org748254c},fragile]{Type classes: composition}
...
\begin{frame}[label={sec:org0652d31}]{Type classes: extensibility}
...
\begin{frame}[label={sec:orgae19ae1}]{Important!}
...
\begin{frame}[label={sec:org3f30a88},fragile]{What is law?}
 \begin{itemize}
...
\begin{frame}[label={sec:orgd29c2d8},fragile]{Instance example}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgd68d893},fragile]{Checking laws - \sout{pen and paper} in comments}
 \begin{minted}[]{scala}
package object implicits {
  implicit val stringSemigroup: Semigroup[String] = new Semigroup[String] {
    override def combine(x: String, y: String): String = x + y
...
\begin{frame}[label={sec:org5203e49}]{Back to Fibonacci}
\begin{equation*}
  \begin{pmatrix}
    F_{n+1} & F_n \\
    F_n & F_{n-1}
...
\begin{frame}[label={sec:org26b01b9},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orgf89f7db}]{Profiling results}
\begin{center}
\begin{tabular}{rrr}
N & Matrix & Tailrec\\
\hline
...
\begin{frame}[label={sec:orgca0cb3c},fragile]{Outcome}
 \begin{itemize}
...
\begin{frame}[label={sec:org29a4a05},fragile]{Homework}
...
\section*{Logger}
\label{sec:org6bb43cf}

\begin{frame}[label={sec:org9e7b499}]{Many monoids}
...
\begin{frame}[label={sec:orgc316890},fragile]{Let's start with some wrappers (pun intended)}
 \begin{itemize}
...
\begin{frame}[label={sec:org94458ec},fragile]{Logger}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org6bcd834},fragile]{Logger}
 \begin{itemize}
...
\begin{frame}[label={sec:orgaca87a9},fragile]{Bonus questions}
 \begin{itemize}
...
\begin{frame}[label={sec:org5c83fd4},fragile]{Outcome}
 \begin{itemize}
