...
\begin{frame}[label={sec:orgeaf6ca8},fragile]{Summoning the summoner}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Introducible[A] {
...
\begin{frame}[label={sec:org664bb07}]{What have we done?}
...
\begin{frame}[label={sec:org7b9045a},fragile]{Coding time}
 \begin{itemize}
