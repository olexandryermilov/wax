...
- <1-> If you have a monoid, it's easy to form new monoid (of a higher rank).
- <2-> Functions can also be monoid. This is really cool by itself.
- <3-> Some of you probably gonna write a new =colog= lib (but for Scala).
